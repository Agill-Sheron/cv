      ...
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1 space-y-1.5">
            <h1 className="text-2xl font-bold">{t('resume.name')}</h1>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base">
                    ...
                    <div className="text-sm tabular-nums text-gray-500">
                      {t(`resume.work.${index}.start`)} - {t(`resume.work.${index}.end`)}
                    </div>
                  </div>

                  <h4 className="font-mono text-sm leading-none">
                    {t(`resume.work.${index}.title`)}
                  </h4>
                </CardHeader>
                <CardContent className="mt-2 text-xs">
                  {t(`resume.work.${index}.description`)}
                </CardContent>
              </Card>
            );
          })}
                ...
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base">
                    <h3 className="font-semibold leading-none">
                      {t(`resume.education.${index}.school`)}
                    </h3>
                    <div className="text-sm tabular-nums text-gray-500">
                      {t(`resume.education.${index}.start`)} - {t(`resume.education.${index}.end`)}
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="mt-2">{t(`resume.education.${index}.degree`)}</CardContent>
              </Card>
            );
          })}
        </Section>
